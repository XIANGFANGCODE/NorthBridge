...
class MyTestCase(unittest.TestCase):
    def test_case1(self):
        ...
        signal = SignalMA('huobi', 'btc', 'buy', 100, '20190517', 1, 2 , 2, 1)
    ...
    def test_case2(self):
        ...
        account = Account('test')
        account.get_account('huobi','20190517', get_basic_currency('btc'), 100000)
        signal = SignalMA('huobi', 'btc', 'sell', 100, '20190517', 1, 2 , 2, 1)
        orders = Order.create_orders(mode, trade_limit, account, signal)
        for order in orders:
            order.desc()
    ...
    def test_case4(self):
        ...
        account = Account('test')
        account.get_account('huobi','20190517', get_basic_currency('btc'), 100000)
        signal1 = SignalMA('huobi', 'btc', 'buy', 100, '20190517', 1, 2 , 2, 1)
        signal2 = SignalMA('huobi', 'btc', 'sell', 200, '20190517', 1, 2, 2, 1)
        signal3 = SignalMA('huobi', 'btc', 'buy', 100, '20190517', 1, 2, 2, 1)
        signal4 = SignalMA('huobi', 'btc', 'sell', 200, '20190517', 1, 2, 2, 1)
