...
class Order:
    ...
    def desc(self):
        print('exchange: {}, object: {}, object_type ： {}, object_action: {}, '
              'amount_of_object: {}, price: {}, amount_of_basic_currency: {}, datetime: {}, futures_action: {}'.format(
            self.exchange,
            self.object,
            self.object_type,
            self.object_action,
    ...
    def _create_orders_by_allin(trade_limit, account, signal):
        ...
        if signal.action == 'buy':
            if trade_limit == 'buy':
                ...
                basic_currency_in_account = get_value_from_dict(account.spot_account.account, signal.exchange, basic_currency)
